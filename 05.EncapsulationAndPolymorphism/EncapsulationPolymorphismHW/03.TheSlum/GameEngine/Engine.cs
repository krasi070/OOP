namespace _03.TheSlum.GameEngine
{
    using System;
                    ...
                    switch (inputParams[2].ToLower())
                    {
                        case "axe":
                            character.AddToInventory(
                                new Axe(inputParams[3]));
                            break;
                        case "shield":
                            character.AddToInventory(
                                new Shield(inputParams[3]));
                            break;
                        case "injection":
                            character.AddToInventory(
                                new Injection(inputParams[3]));
                            break;
                        case "pill":
                            character.AddToInventory(
                                new Pill(inputParams[3]));
                            break;
                    }
                    break;
                }
